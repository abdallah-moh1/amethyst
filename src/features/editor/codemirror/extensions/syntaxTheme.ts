...
const markdownHighlightStyle = HighlightStyle.define([
    // Headings
    { tag: tags.heading1, fontSize: "1.9em", fontWeight: "800", color: "var(--editor-markdown-heading-1)" },
    { tag: tags.heading2, fontSize: "1.6em", fontWeight: "750", color: "var(--editor-markdown-heading-2)" },
    { tag: tags.heading3, fontSize: "1.35em", fontWeight: "700", color: "var(--editor-markdown-heading-3)" },
    { tag: tags.heading4, fontSize: "1.2em", fontWeight: "700", color: "var(--editor-markdown-heading-4)" },
    { tag: tags.heading5, fontSize: "1.1em", fontWeight: "700", color: "var(--editor-markdown-heading-5)" },
    { tag: tags.heading6, fontSize: "1em", fontWeight: "700", color: "var(--editor-markdown-heading-6)" },
    ...
    { tag: tags.monospace, fontFamily: "ui-monospace, monospace", color: "var(--editor-markdown-inline-code-text)" },
